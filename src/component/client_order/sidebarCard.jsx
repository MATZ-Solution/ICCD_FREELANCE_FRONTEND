...
const SidebarCard = ({
  ...
  title,
  type,
  packagesJson, // JSON string from DB
}) => {
  ...
  // Extract concepts separately
  const concepts = parsedFeatures.concepts || null;
  delete parsedFeatures.concepts; // remove from dynamic features
  ...
  return (
    <div className="p-4 sm:p-6 bg-white rounded-lg shadow-md">
      ...
      <p className="text-sm capitalize text-gray-700 mt-4 mb-6">
        {description}
      </p>

      {/* Delivery, Revisions & Concepts */}
      <div className="flex flex-row items-center gap-2 mb-4">
        {concepts && (
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-gray-700">{concepts} Concepts</span>
          </div>
        )}
        <div className="flex items-center space-x-2">
          <svg
