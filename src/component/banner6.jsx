    ...
    <div className="px-3 sm:px-10 mt-10">
      <section className="flex flex-col items-center p-6 md:p-12 rounded-2xl">
        ...
        <div className="w-full text-center md:text-left mb-10">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-black mb-10 lg:w-2/3 lg:leading-tight">
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full">
            {testimonials.map((item, index) => (
              <div
                ...
                className="flex-1 px-4 sm:px-6 py-6 rounded-xl text-white cursor-pointer transition transform hover:scale-105"
              >
