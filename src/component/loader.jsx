  ...
  return (
    <>
      <style jsx>{`
        ...
        .bounce-2 { animation: bounce 1s ease-in-out infinite 0.2s; }
        .bounce-3 { animation: bounce 1s ease-in-out infinite 0.4s; }
      `}</style>
      ...
      >
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="relative w-54 h-54">
            <div className="absolute inset-0 rounded-full border-12 border-t-[#4AADB6] border-r-transparent border-b-transparent border-l-transparent spin-animation"></div>
            <div className="w-full h-full flex items-center justify-center pulse-animation">
              <img src={logo} alt="ICCD Logo" className="w-30 h-30 object-contain" />
            </div>
          </div>

          <div className="text-center">
            <h1 className="text-xl md:text-2xl font-semibold text-gray-800 mb-2">ICCD</h1>
            <p className="text-sm text-gray-600">Islamic Chamber of Commerce & Development</p>
          </div>
        </div>
      </div>
    </>
