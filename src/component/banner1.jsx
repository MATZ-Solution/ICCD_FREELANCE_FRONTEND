    ...
    <div className="px-3 sm:px-10 mt-10">
              ...
              <button
                ...
                className={` ${
                  btnState === "find-talent"
                    ? "bg-white text-black"
                    : "text-white"
                } flex-1 h-10 rounded-full text-sm sm:text-base transition duration-300 cursor-pointer`}
              >
                Find Talent
              </button>
              <button
            ...
            {btnState === "browse-jobs" && (
              <div className="flex flex-col gap-2 items-center ">
                <p className="text-white text-center text-sm sm:text-base md:text-lg">
                  Grow your freelancing career with opportunities from across
                  the OIC.
                </p>
                <button
      ...
      <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6">
        {categories.map((cat, i) => (
          <div
            onClick={() =>
              navigate(`/find-talent?search=${encodeURIComponent(cat.value)}`)
            }
            key={i}
          ...
          >
            <div className={`p-2 sm:p-3 rounded-lg ${cat.bg}`}>{cat.icon}</div>
            <div>
