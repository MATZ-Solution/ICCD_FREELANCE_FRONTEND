...
export default function HowItWorks() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50">
      {/* Hero Section */}
      <section id="hero" className="relative py-20 px-6 bg-gradient-to-br from-[#47AAB3] via-[#3A8F97] to-[#2D6F75] text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <div className={`transition-all duration-1000 ${isVisible('hero') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-2xl md:text-3xl text-teal-100 mb-8">
            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="bg-gradient-to-r from-[#47AAB3] via-[#3A8F97] to-[#2D6F75] p-6 flex items-center space-x-4">
                      ...
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-2xl font-bold text-[#47AAB3]">
                        {step.number}
                      </div>
                    </div>
                    ...
                    <div className="p-8">
                      {step.description ? (
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-6">
                          <div className="bg-teal-50 p-6 rounded-xl">
                            <h4 className="font-bold text-[#2D6F75] mb-3 flex items-center">
                      ...
                      <div className="bg-gradient-to-r from-[#47AAB3] to-[#3A8F97] p-4 rounded-lg border-l-4 border-[#47AAB3]">
      ...
      <section id="comparison" className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className={`transition-all duration-1000 ${isVisible('comparison') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-center text-[#2D6F75] mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Freelancers */}
              <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-[#47AAB3] to-[#3A8F97] rounded-full flex items-center justify-center mr-4">
                    <Briefcase className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-3xl font-bold text-[#2D6F75]">For Freelancers</h3>
                </div>
                    ...
                    return (
                      <div key={idx} className="flex items-start space-x-3 bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <div className="flex items-center space-x-2">
                          <BenefitIcon className="w-5 h-5 text-[#47AAB3]" />
              ...
              {/* Employers */}
              <div className="bg-gradient-to-br from-cyan-50 to-teal-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-[#47AAB3] to-[#3A8F97] rounded-full flex items-center justify-center mr-4">
                    <Users className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-3xl font-bold text-[#2D6F75]">For Employers</h3>
                </div>
      ...
      {/* CTA Section */}
      <section id="cta" className="py-20 px-6 bg-gradient-to-r from-[#47AAB3] via-[#3A8F97] to-[#2D6F75] text-white">
        <div className="max-w-5xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="group bg-white text-[#2D6F75] hover:bg-cyan-50 font-bold py-5 px-12 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center justify-center">
                <UserPlus className="w-6 h-6 mr-2 group-hover:rotate-12 transition-transform" />
                Join as Freelancer
              </button>
              <button className="group bg-[#5BC0C9] hover:bg-[#6DD5DE] text-white font-bold py-5 px-12 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center justify-center">
