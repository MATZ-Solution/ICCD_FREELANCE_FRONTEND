...
import { ChevronDown, HelpCircle, Users, DollarSign, Shield, Globe, Award, Briefcase, MessageSquare, Bell, CheckCircle, Search } from 'lucide-react';
...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Anyone from an OIC member country or beyond who shares our values of professionalism, transparency, and ethical work can join. The platform is open to:',
      list: [
    ...
    },
    {
      id: 4,
      icon: Award,
      question: 'How is ICCD Talent Gate different from other freelancing websites?',
      answer: 'Unlike conventional freelancing platforms, ICCD Talent Gate is community-centric and ethically guided. It focuses on:',
      list: [
    ...
    },
    {
      ...
      answer: 'All payments are processed through a secure payment gateway integrated within the platform. Once a client approves the completed work, payment is released to the freelancer\'s account. The process ensures fairness and transparency at every step.',
      category: 'Payments'
    },
    {
      id: 6,
      ...
      answer: 'Registration on ICCD Talent Gate is free for both freelancers and employers. A small service fee is deducted only after successful project completion — ensuring that costs are linked to outcomes, not participation.',
      category: 'Payments'
    },
    {
      id: 7,
      ...
      answer: 'Each user undergoes an account verification process, which includes:',
      list: [
    ...
    },
    {
      ...
      answer: 'Yes. ICCD Talent Gate is open to users worldwide, though it prioritizes talent and organizations from OIC member states. Employers from any country can hire freelancers, and freelancers from across the Muslim world can serve international clients.',
      category: 'General'
    },
    {
      id: 9,
      ...
      answer: 'ICCD Talent Gate follows strict data protection protocols and international privacy standards. All user data is encrypted, securely stored, and used only for operational purposes. We never sell or share personal data with third parties without consent. (See our Privacy Policy for details.)',
      category: 'Security'
    },
    {
      id: 10,
      ...
      answer: 'The platform includes a dispute resolution mechanism managed by ICCD\'s moderation team. Users can report issues through the "Report a Problem" form, and our support team will investigate promptly to ensure fair and transparent outcomes.',
      category: 'Support'
    },
    {
      id: 11,
      icon: Users,
      question: 'Can I use ICCD Talent Gate for non-commercial or voluntary projects?',
      answer: 'Yes. The platform encourages community impact projects and volunteering opportunities — especially those aligned with humanitarian, educational, or development goals within the OIC region.',
      category: 'Services'
    },
    {
      id: 12,
      ...
      answer: 'Users can subscribe to the ICCD Talent Gate newsletter and follow official ICCD social media channels for announcements, training sessions, and capacity-building programs related to digital work and entrepreneurship.',
      category: 'Updates'
    }
  ];
            ...
            <div className="space-y-4">
              {filteredFAQs.map((faq, idx) => {
                ...
                return (
                  <div
                    key={faq.id}
                    className={`transition-all duration-500 ${isVisible('faqs') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}
                    ...
                    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                      ...
                      <div className={`transition-all duration-300 ease-in-out ${
                        ...
                        <div className="px-6 pb-6 pt-2 pl-20">
                          ...
                          {faq.note && (
                            <p className="text-sm text-gray-500 italic">{faq.note}</p>
                          )}
                        </div>
                      </div>
                    </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Our support team is here to help you. Reach out and we'll get back to you as soon as possible.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-blue-900 hover:bg-blue-50 font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center justify-center">
                <MessageSquare className="w-5 h-5 mr-2" />
                Contact Support
              </button>
              <button className="bg-amber-500 hover:bg-amber-600 text-white font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center justify-center">
