...
export default function ICCDAboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      {/* Hero Section */}
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden  bg-gradient-to-r from-[#44A4AD] via-[#2E7A81] to-[#1C4C50]">
        <div 
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          <div className={`transition-all duration-1000 ${isVisible('hero') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <Globe className="w-20 h-20 mx-auto mb-6 text-[#47AAB3] animate-pulse" />
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              A Gateway for Muslim Talent to the <span className="text-[#16c5d5]">Global Digital Economy</span>
            </h1>
            ...
            <button onClick={() => navigate('/signup')} className="bg-[#47AAB3] hover:bg-[#47AAB3] text-white font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl">
      ...
      <section id="story" className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className={`transition-all duration-1000 delay-200 ${isVisible('story') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-[#1D5054] mb-8 text-center">
              Bridging Skills and Opportunity Across the Muslim World
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
              <p className="text-xl leading-relaxed">
                The Islamic Chamber of Commerce and Development (ICCD) launched the Talent Gate to respond to one of the most pressing needs of our time — <span className="font-semibold text-[#1D5054]">digital employability</span>.
              </p>
              <p className="text-xl leading-relaxed">
              ...
              <p className="text-xl leading-relaxed">
                ICCD Talent Gate aims to break these barriers by building a <span className="font-semibold text-[#1D5054]">trusted, inclusive, and ethical digital marketplace</span>, where talent meets opportunity and where the collective potential of the Muslim Ummah becomes a force for shared prosperity.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="mission" className="py-20 px-6 bg-gradient-to-br from-blue-50 to-teal-50">
        <div className="max-w-6xl mx-auto">
          <div className={`transition-all duration-1000 delay-300 ${isVisible('mission') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="text-4xl md:text-5xl font-bold text-[#1D5054] mb-6 text-center">
              Our Mission
            </h2>
            <p className="text-2xl text-center text-[#1D5054] mb-16 font-semibold">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  <goal.icon className="w-12 h-12 text-[#1D5054] mb-4" />
      ...
      <section id="why" className="py-20 px-6 bg-gradient-to-br from-[#1D5054] to-teal-800 text-white">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-xl border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-300">
                  <h3 className="text-xl font-bold mb-2 text-[#47AAB3]">{feature.title}</h3>
          ...
          <div className={`transition-all duration-1000 delay-500 ${isVisible('impact') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg">
                <TrendingUp className="w-16 h-16 text-[#1D5054] mx-auto mb-4" />
                <div className="text-5xl font-bold text-[#1D5054] mb-2">10,000+</div>
              ...
              <div className="text-center p-8 bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl shadow-lg">
                <Heart className="w-16 h-16 text-[#47AAB3] mx-auto mb-4" />
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="flex items-start space-x-4 bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
                  <div className="w-8 h-8 rounded-full bg-[#1D5054] text-white flex items-center justify-center font-bold flex-shrink-0 mt-1">
                    {idx + 1}
                  </div>
      ...
      {/* Partners */}
      <section id="partners" className="py-20 px-6 bg-gradient-to-br from-[#1D5054] to-[#1D5054] text-white">
        <div className="max-w-5xl mx-auto text-center">
          <div className={`transition-all duration-1000 delay-700 ${isVisible('partners') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <blockquote className="text-2xl italic font-light text-[#47AAB3] border-l-4 border-[#47AAB3] pl-6 py-4 max-w-3xl mx-auto">
      ...
      {/* CTA */}
      <section id="cta" className="py-24 px-6 bg-gradient-to-br from-[#47AAB3] to-[#47AAB3]">
        <div className="max-w-5xl mx-auto text-center">
          <div className={`transition-all duration-1000 delay-800 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button onClick={() => navigate('/freelancer-profile')}  className="bg-white text-[#47AAB3] hover:bg-amber-50 font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-xl">
                Start Freelancing
              </button>
              <button onClick={() => navigate('/find-talent')}  className="bg-[#1D5054] text-white hover:bg-[#1D5054] font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-xl">
                Hire a Professional
              </button>
              <button onClick={() => navigate('/how-it-works')} className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#47AAB3] font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105">
                Learn About ICCD
              </button>
            </div>
          </div>
