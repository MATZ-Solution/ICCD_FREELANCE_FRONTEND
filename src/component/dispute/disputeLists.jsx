...
function DisputeLists({ data }) {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-10 mt-6">
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">My Disputes</h1>
        <p className="text-gray-600 text-sm sm:text-base">Manage and track your dispute cases</p>
      </div>
                ...
                <div className="flex flex-col md:flex-row md:justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      <div>
                        <p className="text-sm text-gray-500 mb-1">Counterpart</p>
                        <div className="flex flex-wrap items-center gap-2">
                          <span className="font-medium text-gray-900">{dispute.name}</span>
                          <span
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{getDateLabel(dispute.created_at)}</p>
                      </div>
                  ...
                  <div className="flex-shrink-0 flex items-start sm:items-center gap-2 mt-2 sm:mt-0">
                    <button
      ...
      {/* Status Legend */}
      <div className="mt-6 flex flex-col sm:flex-row sm:justify-between text-sm text-gray-500 gap-2 sm:gap-0">
        <span>Showing {data?.length} dispute{data?.length !== 1 ? "s" : ""}</span>
