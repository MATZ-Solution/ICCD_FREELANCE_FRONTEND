...
const QuickLinksSidebar = ({ educationList, certificationList, skillsList, languages, openSidebar }) => (
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-3 text-center">
            <div className="p-2 bg-gray-50 rounded-md">
              <div className="text-lg font-semibold text-gray-900">{educationList.length}</div>
              <div className="text-xs text-gray-500">Education</div>
            </div>
            <div className="p-2 bg-gray-50 rounded-md">
              <div className="text-lg font-semibold text-gray-900">{certificationList.length}</div>
              <div className="text-xs text-gray-500">Certificates</div>
            </div>
            <div className="p-2 bg-gray-50 rounded-md">
              <div className="text-lg font-semibold text-gray-900">{skillsList.length}</div>
