...
//   return (
//     <div
//       className="relative border-4 border-l-amber-300 rounded-2xl p-5 text-white overflow-hidden shadow-md hover:shadow-xl transition-shadow cursor-pointer"
...
//         {/* Icon */}
//         {icon && (
//           <div className="w-11 h-11 bg-amber-300 rounded-xl flex items-center justify-center shadow-inner">
//             {icon}
//           </div>
//         )}
...
//           <p className="text-normal text-gray-500 font-medium leading-tight">{title}</p>
//           <p className="text-3xl text-amber-300 font-bold leading-none">{value}</p>
