    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="flex flex-col items-center justify-center bg-white rounded-lg w-full lg:w-[50%] mx-4 p-6">
                {/* Header */}
                <img className='w-40 h-28 lg:w-52 lg:h-32' src={thank_you_pic}></img>
                <h3 className='text-center text-lg mt-5 text-[#043A53] sm:text-2xl font-semibold'>Your application has been submitted!</h3>
                <p className='mt-2 text-center text-sm text-[#767676]'>You will get an email confirmation at muhammadtalhabutt8@gmail.com</p>
