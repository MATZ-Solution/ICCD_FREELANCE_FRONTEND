    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">View and manage customer feedback</p>
        </div>
          ...
          {data && data.length > 0 ? (
            data.map((feedback) => (
              ...
              >
                ...
                <p className="text-gray-700 mb-3 line-clamp-2">{feedback.message || feedback.comment}</p>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900">No feedback found</h3>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between mt-8 bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
            ...
            <span className="text-sm font-medium text-gray-700">
              Page <span className="text-[#3c9299] font-bold">{currentPage}</span> of {totalPages}
            </span>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8 space-y-6">
              <div>
                ...
                <p className="mt-1 text-lg font-semibold text-gray-900">{selectedFeedback.name || 'Anonymous'}</p>
              </div>
              
              <div>
                <label className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Email</label>
                <p className="mt-1 text-lg text-gray-900">{selectedFeedback.email || 'No email provided'}</p>
              </div>
              
              {selectedFeedback.rating && (
                <div>
                  <label className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Rating</label>
              ...
              {selectedFeedback.status && (
                <div>
                  ...
                  <div className="mt-1">
                    <span className={`inline-block px-4 py-2 rounded-xl text-sm font-medium ${getStatusColor(selectedFeedback.status)}`}>
