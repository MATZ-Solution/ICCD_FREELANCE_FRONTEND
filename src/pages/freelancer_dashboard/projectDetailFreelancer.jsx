                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-wrap gap-4 pt-4">
                                    <div className="flex items-center gap-3 bg-gradient-to-r from-blue-50 to-cyan-50 px-5 py-3 rounded-xl border border-blue-200 hover:border-blue-300 transition-all">
                                        ...
                                        <span className="font-semibold text-blue-900">{project?.mode || "N/A"}</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 bg-gradient-to-r from-emerald-50 to-teal-50 px-5 py-3 rounded-xl border border-emerald-200 hover:border-emerald-300 transition-all">
                                        ...
                                        <span className="font-semibold text-emerald-900">{project?.duration || "N/A"}</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3 bg-gradient-to-r from-purple-50 to-pink-50 px-5 py-3 rounded-xl border border-purple-200 hover:border-purple-300 transition-all">
                                        ...
                                        <span className="font-semibold text-purple-900">Hiring {project?.total_freelancer || 0} Freelancers</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl shadow-md border border-blue-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-blue-200">
                            ...
                            <div className="p-8 space-y-6">
                                <p className="text-gray-700 leading-relaxed text-lg">
                                    <div dangerouslySetInnerHTML={{ __html: project?.overview || "No overview available" }} />
                                </p>
                        ...
                        <div className="bg-white rounded-3xl shadow-md border border-blue-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-blue-200">
                            ...
                            <div className="p-8 space-y-6">
                                <p className="text-gray-700 leading-relaxed text-lg">
                                    <div dangerouslySetInnerHTML={{ __html: project?.deliverable || "No deliverables specified" }} />
                                </p>
                        ...
                        <div className="bg-white rounded-3xl shadow-md border border-blue-100 p-8 hover:shadow-xl transition-all duration-300 hover:border-blue-200">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100 hover:border-blue-200 transition-all hover:shadow-md">
                                    ...
                                    <p className="text-gray-900 font-bold text-lg">{project?.type || "N/A"}</p>
                                </div>
                                ...
                                <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 hover:border-emerald-200 transition-all hover:shadow-md">
                                    ...
                                    <p className="text-gray-900 font-bold text-lg">{project?.languages || "N/A"}</p>
                                </div>
                            ...
                            <div className="bg-white rounded-3xl shadow-md border border-blue-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-blue-200">
                                ...
                                <div className="p-8">
                                    <div className="space-y-4">
                                        {project.files.split(',').map((attachment, index) => (
                                            <div 
                                                key={index}
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="font-bold text-gray-900">{attachment.name}</p>
                                                        <p className="text-xs text-gray-500">{attachment.size || "File"}</p>
                                                    </div>
                                                </div>
                                                <a
                                                    href={attachment.url}
                        ...
                        <div className="sticky top-6 space-y-6">
                            ...
                            <div className="bg-white rounded-3xl shadow-md border border-blue-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-blue-200">
                                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-6 border-b border-blue-100">
                                    ...
                                    <div className="text-4xl font-bold text-gray-900">${project?.budget || "0"}</div>
                                </div>
                                ...
                                <div className="p-6 space-y-5">
                                    <div className="flex items-center gap-4">
                                        <img 
                                            ...
                                            src={project?.companyImg || "https://via.placeholder.com/56"} 
                                            alt="Company logo"
                                        />
                                        <div>
                                            <div className="font-bold text-gray-900 text-lg">{project?.companyName || "Company"}</div>
                                            <div className="text-xs text-gray-500 uppercase tracking-wide">Verified Client</div>
                                        </div>
                                    </div>

                                    <p className="text-gray-700 leading-relaxed text-sm">
                                        {project?.companyAbout || "No company information available"}
                                    </p>
                            ...
                            <div className="bg-white rounded-3xl shadow-md border border-blue-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:border-blue-200">
                                ...
                                <div className="p-6">
                                    <div className="grid grid-cols-4 gap-3">
                                        <button className="p-3.5 border-2 border-blue-200 rounded-xl hover:bg-blue-50 hover:border-blue-400 transition-all duration-300 group hover:shadow-md" aria-label="Share on Facebook">
                                            <Facebook className="w-5 h-5 text-blue-600 mx-auto group-hover:scale-125 transition-transform" />
                                        </button>
                                        <button className="p-3.5 border-2 border-sky-200 rounded-xl hover:bg-sky-50 hover:border-sky-400 transition-all duration-300 group hover:shadow-md" aria-label="Share on Twitter">
                                            <Twitter className="w-5 h-5 text-sky-600 mx-auto group-hover:scale-125 transition-transform" />
                                        </button>
                                        <button className="p-3.5 border-2 border-blue-200 rounded-xl hover:bg-blue-50 hover:border-blue-400 transition-all duration-300 group hover:shadow-md" aria-label="Share on LinkedIn">
                                            <Linkedin className="w-5 h-5 text-blue-700 mx-auto group-hover:scale-125 transition-transform" />
                                        </button>
                                        <button className="p-3.5 border-2 border-pink-200 rounded-xl hover:bg-pink-50 hover:border-pink-400 transition-all duration-300 group hover:shadow-md" aria-label="Share on Instagram">
