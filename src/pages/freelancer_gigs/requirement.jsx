  ...
  return (
    <Profile>
      <div className='flex flex-col rounded-md mt-7 gap-6 sm:border-[#AFAFAF] sm:border-[1px] sm:mt-12 sm:gap-10 sm:p-10 md:mt-20'>
        ...
        <div>
          <p className='text-[#8a8a8a]'>These optional questions will be added for all buyers.</p>
          <div className='mt-7 flex flex-col gap-5'>
            {[1, 2].map((index) => (
              <div key={index} className='p-5 rounded-md border-[1px] border-[#c8c8c8] sm:p-12 shadow-md'>
          ...
          <div className='mt-10 flex flex-col gap-5 bg-gray-100 p-6'>
            ...
            <div>
              <textarea
                ...
                className='bg-white w-full h-24 border-[#B8B8B8] border-[1px] px-2 py-2 rounded-md sm:h-12'
              />
      ...
      <div className="mt-5 flex sm:justify-end">
        <Button className='px-5 py-2' onClick={() => navigate('/freelancer/manage-gigs/gallery')}>
          Save & Continue
        </Button>
      </div>
    </Profile>
